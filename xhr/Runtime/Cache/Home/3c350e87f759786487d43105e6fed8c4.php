...
<script src="/xhr/Public/photoClip/hammer.min.js"></script>
<script src="/xhr/Public/photoClip/iscroll-zoom-min.js"></script>
<script src="/xhr/Public/photoClip/lrz.all.bundle.js"></script>
<script src="/xhr/Public/photoClip/PhotoClip.js"></script>
...
//        view: '#view',
        ...
        loadComplete: function() {
            ...
            $.ajax({
                url: "/xhr/index.php/Home/My/pic_rmbcz",
                data: {str: dataURL},
                type: 'post',
                dataType: 'html',
...
//                    parent.$('#scpz').val('我被改变了');
                    ...
                    parent.window.location.href = "/xhr/index.php/Home/My/rmbcz/type/2/scpz/"+msg;
                }
            });
        },
        fail: function(msg) {
