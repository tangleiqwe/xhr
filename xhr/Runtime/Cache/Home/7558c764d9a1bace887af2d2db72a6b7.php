...
<div class="mui-content">
    ...
    <!--<form class="mui-input-group">-->
        ...
        <div class="mui-input-row">
            <h5 ><label style="width: 30%;">开户银行：</label><label style="width:55%;" id="khh"><?=C('yhk_khh')?></label>
            </h5>
        </div>
    <!--</form>-->
    </div>
    ...
    <form class="mui-input-group"   action="/paipai/index.php/Home/My/rmbcz_insert" method="post">
    <div class="mui-input-row">
        <label>充值账号</label>
        <input id='czzh'name="czzh" type="number" class="mui-input-clear mui-input" placeholder="请输入充值的银行帐号" style="font-size: 14px">
    </div>
    <div class="mui-input-row">
        <label>姓名</label>
...
<script>
    function cof() {
        layer.open({
            ...
            shade: 0.8,
            area: ['95%', '470px'],
            content: '/paipai/index.php/Home/My/pic_rmb' //iframe的url
        });
    }
