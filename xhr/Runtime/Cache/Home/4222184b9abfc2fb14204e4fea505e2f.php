        ...
        <ul class="mui-table-view">
            <li class="mui-table-view-cell mui-collapse">
                ...
                <div class="mui-collapse-content">
                    ...
                    <ul class="mui-table-view">
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_1_1.jpg"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_1_2.jpg"></li>
                    </ul>
                    <br>
            ...
            <li class="mui-table-view-cell mui-collapse">
                ...
                <div class="mui-collapse-content">
                            ...
                            <div class="mui-collapse-content">
                                ...
                                <ul class="mui-table-view">
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_1.jpg"></li>
                                    <br>
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_2.jpg"></li>
                                    <br>
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_3.jpg"></li>
                                    <br>
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_4.jpg"></li>
                                    <br>
                                    </ul>
                                <br>
                                    <P>
                                   ...
                                   <ul class="mui-table-view">
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_5.jpg"></li>
                                    <br>
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_6.jpg"></li>
                                    <br>
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_7.jpg"></li>
                                    <br>
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_8.jpg"></li>
                                    </ul>
                            </div>
                            <br>
                            ...
                            <div class="mui-collapse-content">
                                ...
                                <ul class="mui-table-view">
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_9.jpg"></li>
                                    <br>
                                    <li class="imgbox"><img src="/xhr/Public/images/helppai/help_2_10.jpg"></li>
                                    <br>
                                </ul>
                                </div>
                </div>
            ...
            <li class="mui-table-view-cell mui-collapse">
                ...
                <div class="mui-collapse-content">
                    <a class="mui-navigate-right" href="#">1、我要卖π</a>
                     <div class="mui-collapse-content">
                         ...
                         <ul class="mui-table-view">
                             <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_1.png"></li>
                             <br>
                             <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_2.png"></li>
                             <br>
                             <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_3.png"></li>
                             <br>
                             <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_4.png"></li>
                             <br>
                         </ul>
                         </div>
                    <br>
                ...
                <div class="mui-collapse-content">
                    ...
                    <ul class="mui-table-view">
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_5.png"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_6.png"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_7.png"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_8.png"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_3_9.png"></li>
                        <br>
                    </ul>
                    </div>
            ...
            <li class="mui-table-view-cell mui-collapse">
                ...
                <div class="mui-collapse-content">
                    ...
                    <ul class="mui-table-view">
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_4_1.png"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_4_2.png"></li>
                        <br>
                        </ul>
                        </div>
                    <br>
                     ...
                     <div class="mui-collapse-content">
                        ...
                        <ul class="mui-table-view">
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_4_3.png"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_4_4.png"></li>
                        <br>
                    </ul>
                   </div>
            ...
            <li class="mui-table-view-cell mui-collapse">
                ...
                <div class="mui-collapse-content">
                    ...
                    <ul class="mui-table-view">
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_5_1.png"></li>
                        <br>
                        <li class="imgbox"><img src="/xhr/Public/images/helppai/help_5_2.png"></li>
                        <br>
                    </ul>
                </div>
            </li>
