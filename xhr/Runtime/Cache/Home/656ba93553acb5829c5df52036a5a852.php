...
<script src='/dcdw/Public/js/feedback.js'></script>
    ...
    <script src="/dcdw/Public/libs/echarts-all.js"></script>
</head>
 ...
 if($_SESSION['user']) { ?>
        <ul class="mui-table-view mui-table-view-chevron">
            <li class="mui-table-view-cell">
                ...
                <a class="mui-navigate-right" href="/dcdw/index.php/Home/My/index">
                    <img class="mui-media-object mui-pull-left head-img" id="head-img" src="/dcdw/Public/<?php if(empty($user['headimg'])) { echo 'images/logo.png'; } else { echo 'upload/'.$user['headimg']; } ?>">
        ...
        <ul class="mui-table-view mui-table-view-chevron">
            <li class="mui-table-view-cell">
                <!--<a class="mui-navigate-right" href="#">产品</a>-->
                <a class="mui-navigate-right" href="/dcdw/index.php/Home/User/login">
                    <img class="mui-media-object mui-pull-left head-img" id="head-img" src="/dcdw/Public/images/logo.png">
                    <div class="mui-media-body">
                        游客
    ...
    <div class="mui-card">
        <!--<div class="mui-card-header mui-card-media">
            <img src="/dcdw/Public/images/logo.png" />
            <div class="mui-media-body">
                PAIPAI
                <p>刷新于
                    <?=date('Y-m-d H:i:s')?>
        ...
        <div class="mui-card-content" >
            ...
            <!--<img src="/dcdw/Public/images/yuantiao.jpg" alt="" width="100%"/>-->
        </div>
        <div class="mui-card-footer">
            <a style="width: 40%;color: #00a2d4" class=" mui-btn mui-icon mui-icon-undo " href="/dcdw/index.php/Home/My/trad/type/2"><h4>买</h4></a>
            <a style="width: 40%;color: #00a2d4" class=" mui-btn mui-icon mui-icon-redo " href="/dcdw/index.php/Home/My/sell_n"> <h4>卖</h4></a>
    ...
    <div class="mui-card">
        ...
        <div class="mui-card-footer">
            ...
            <a class="mui-card-link" href="/dcdw/index.php/Home/My/trad">Read more</a>
        </div>
    </div>
</div>
