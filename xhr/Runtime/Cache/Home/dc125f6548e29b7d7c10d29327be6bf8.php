...
<div class="mui-content">
        ...
        <ul class="mui-table-view mui-table-view-chevron">
            <li class="mui-table-view-cell" onclick="cof()">
                ...
                <a class="mui-navigate-right" href="#">
                    <img class="mui-media-object mui-pull-left head-img" id="head-img" src="/paipai/Public/<?php if(empty($headimg)) { echo 'images/logo.png'; } else { echo 'upload/'.$headimg; } ?>">
    ...
    <div class="mui-card">
    <form class="mui-input-group" action="/paipai/index.php/Home/My/jbxxxg_update" method="post">
        <div class="mui-input-row" style="background:#F5F5F5 ">
            <h5 class="mui-content-padded" >基本信息</h5>
                </div>
            <div class="mui-input-row">
                <label>*姓名</label>
                <input id='xm'name="xm" type="text"  class=" mui-input" placeholder="请输入姓名" value="<?=$xm?>">
            </div>
            <div class="mui-input-row">
            <label>*电话</label>
            ...
            <div class="mui-input-row">
                <label>*开户行</label>
                <input id='khh'name="khh" type="text" class="mui-input-clear mui-input" placeholder="请输入开户行信息"value="<?=$khh?>">
            </div>
            <div class="mui-input-row">
            ...
            <div class="mui-input-row">
                <label style=" width: 35%;">*链克账户</label>
                <input id='pzh' name="pzh"  style=" width: 65%;" type="text" class="mui-input-clear mui-input" placeholder="请输入链克账户"value="<?=$pzh?>">
            </div>
            <!--<div class="mui-input-row">-->
                <!--<label style=" width: 35%;">*手机号后四位</label>-->
                <!--<input id='pzhhsw'name="pzhhsw" style=" width: 65%;" type="number" class="mui-input-clear mui-input" placeholder="请输入Discovery账号手机号后四位"value="<?=$pzhhsw?>">-->
            <!--</div>-->
...
<script>
    function cof() {
        layer.open({
            ...
            shade: 0.8,
            area: ['95%', '470px'],
            content: '/paipai/index.php/Home/My/pic' //iframe的url
        });
    }
</script>
</body>
