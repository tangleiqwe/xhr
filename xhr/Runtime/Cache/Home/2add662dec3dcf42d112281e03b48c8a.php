...
<!--标准mui.css-->
<link rel="stylesheet" href="/bak/paipai/Public/css/mui.min.css">
<!--App自定义的css-->
<link rel="stylesheet" type="text/css" href="/bak/paipai/Public/css/app.css"/>
<link href="/bak/paipai/Public/css/style.css" rel="stylesheet" />
<link rel="stylesheet" type="text/css" href="/bak/paipai/Public/css/icons-extra.css" />


<script type="text/javascript">
	var URL = "/bak/paipai/index.php/Home/User";
	var APP = "/bak/paipai/index.php";
	var ROOT = "/bak/paipai";
	var PUBLIC = ROOT + "/Public";
	var UPLOAD = "<?php echo $_SERVER['DOCUMENT_ROOT'];?>" + "/upload/";
</script>
<script src="/bak/paipai/Public/js/mui.min.js"></script>
<script src="/bak/paipai/Public/js/mui.enterfocus.js"></script>
<script src="/bak/paipai/Public/js/app.js"></script>
<script src="/bak/paipai/Public/js/mui.view.js "></script>
<script src='/bak/paipai/Public/js/feedback.js'></script>
    <style>
    ...
    <script src="/bak/paipai/Public/libs/echarts-all.js"></script>
</head>

<body>
<header class="mui-bar mui-bar-nav" style="height: 50px">
    <img src="/bak/paipai/Public/images/logo1.png" style="height: 90%; padding-top: 10px">
...
<nav class="mui-bar mui-bar-tab">
    <ul class="mui-table-view mui-grid-view mui-grid-12" style="padding: 0 0 3px 0">
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"  style="color: #2D93CA; font-weight: bolder">
            <a href="/bak/paipai/index.php/Home/User/index">
        ...
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="/bak/paipai/index.php/Home/My/trad">
        ...
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="/bak/paipai/index.php/Home/My/jylist">
        ...
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="/bak/paipai/index.php/Home/My/index">
 ...
 if($_SESSION['user']) { ?>
        <ul class="mui-table-view mui-table-view-chevron">
            <li class="mui-table-view-cell">
                ...
                <a class="mui-navigate-right" href="/bak/paipai/index.php/Home/My/index">
                    <img class="mui-media-object mui-pull-left head-img" id="head-img" src="/bak/paipai/Public/<?php if(empty($user['headimg'])) { echo 'images/logo.png'; } else { echo 'upload/'.$user['headimg']; } ?>">
        ...
        <div class="mui-card-footer">
            <a class="mui-card-link">玩客钱包：<span class="mui-badge mui-badge-warning "><?=number_format($qb['pnum'],2)?></span></a>
            <a class="mui-card-link">RMB钱包：<span class="mui-badge mui-badge-warning "><?=number_format($qb['xjnum'],2)?></span></a>
        </div>
        <?php } else {?>
        <ul class="mui-table-view mui-table-view-chevron">
            <li class="mui-table-view-cell">
                <!--<a class="mui-navigate-right" href="#">产品</a>-->
                <a class="mui-navigate-right" href="/bak/paipai/index.php/Home/User/login">
                    <img class="mui-media-object mui-pull-left head-img" id="head-img" src="/bak/paipai/Public/images/logo.png">
                    <div class="mui-media-body">
                        游客
    ...
    <div class="mui-card">
        <!--<div class="mui-card-header mui-card-media">
            <img src="/bak/paipai/Public/images/logo.png" />
            <div class="mui-media-body">
                PAIPAI
                <p>刷新于
                    <?=date('Y-m-d H:i:s')?>
        ...
        <div class="mui-card-content" >
            ...
            <!--<img src="/bak/paipai/Public/images/yuantiao.jpg" alt="" width="100%"/>-->
        </div>
        <div class="mui-card-footer">
            <a style="width: 40%;color: #00a2d4" class=" mui-btn mui-icon mui-icon-undo " href="/bak/paipai/index.php/Home/My/trad/type/2"><h4>买</h4></a>
            <a style="width: 40%;color: #00a2d4" class=" mui-btn mui-icon mui-icon-redo " href="/bak/paipai/index.php/Home/My/sell_n"> <h4>卖</h4></a>
    ...
    <div class="mui-card">
        ...
        <div class="mui-card-header">玩客币/RMB</div>
        <div class="mui-card-content" >
        ...
        <div class="mui-card-footer">
            ...
            <a class="mui-card-link" href="/bak/paipai/index.php/Home/My/trad">Read more</a>
        </div>
    </div>
</div>
