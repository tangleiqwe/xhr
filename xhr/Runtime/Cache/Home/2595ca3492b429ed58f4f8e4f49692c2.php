...
<script src='/xhr/Public/js/feedback.js'></script>
    ...
    <script src="/xhr/Public/libs/echarts-all.js"></script>
</head>
...
<nav class="mui-bar mui-bar-tab">
    <ul class="mui-table-view mui-grid-view mui-grid-12" style="padding: 0 0 3px 0">
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"  style="color: #2D93CA; font-weight: bolder">
            <a href="/xhr/index.php/Home/User/index">
        ...
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="/xhr/index.php/Home/My/trad">
        ...
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="/xhr/index.php/Home/My/jylist">
        ...
        <li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3"><a href="/xhr/index.php/Home/My/index">
 ...
 if($_SESSION['user']) { ?>
        <ul class="mui-table-view mui-table-view-chevron">
            <li class="mui-table-view-cell">
                ...
                <a class="mui-navigate-right" href="/xhr/index.php/Home/My/index">
                    <img class="mui-media-object mui-pull-left head-img" id="head-img" src="/xhr/Public/<?php if(empty($user['headimg'])) { echo 'images/logo.png'; } else { echo 'upload/'.$user['headimg']; } ?>">
        ...
        <ul class="mui-table-view mui-table-view-chevron">
            <li class="mui-table-view-cell">
                <!--<a class="mui-navigate-right" href="#">产品</a>-->
                <a class="mui-navigate-right" href="/xhr/index.php/Home/User/login">
                    <img class="mui-media-object mui-pull-left head-img" id="head-img" src="/xhr/Public/images/logo.png">
                    <div class="mui-media-body">
                        游客
    ...
    <div class="mui-card">
        ...
        <div class="mui-card-content" >
            ...
            <!--<img src="/xhr/Public/images/yuantiao.jpg" alt="" width="100%"/>-->
        </div>
        <div class="mui-card-footer">
            <a style="width: 40%;color: #00a2d4" class=" mui-btn mui-icon mui-icon-undo " href="/xhr/index.php/Home/My/trad/type/2"><h4>买</h4></a>
            <a style="width: 40%;color: #00a2d4" class=" mui-btn mui-icon mui-icon-redo " href="/xhr/index.php/Home/My/sell_n"> <h4>卖</h4></a>
    ...
    <div class="mui-card">
        ...
        <div class="mui-card-footer">
            ...
            <a class="mui-card-link" href="/xhr/index.php/Home/My/trad">Read more</a>
        </div>
    </div>
</div>
