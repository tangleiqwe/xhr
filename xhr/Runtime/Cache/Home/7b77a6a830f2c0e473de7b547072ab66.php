...
<div class="mui-content">
    <div class="mui-content-padded">
        ...
        <br>
        <button id="cBtn_pic" type="button" class="mui-btn mui-btn-success mui-btn-block"  onclick="cof()">选择图片</button>
        <button id="clipBtn" type="button" class="mui-btn mui-btn-warning mui-btn-block" style="width: 90%">确认选取并上传</button>
...
//        view: '#view',
        ...
        loadComplete: function() {
            ...
            $.ajax({
                url: "/paipai/index.php/Home/User/up",
                data: {str: dataURL},
                type: 'post',
                dataType: 'html',
