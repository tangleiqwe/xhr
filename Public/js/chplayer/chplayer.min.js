	...
	chplayer.prototype = {
		...
		getVideo: function() {
			...
			if (this.html5Video) {
				...
				var html = '';
				if (!this.isM3u8) {
					html = '<video id="' + vid + '"' + src + ' width="100%" height="100%"' + autoplay + poster + loop + ' webkit-playsinline="true" x5-video-player-type="h5">' + source + track + '</video>'
				} else {
					html = '<video id="' + vid + '" width="90%" height="100%"' + poster + loop + ' webkit-playsinline="true">' + track + '</video>'
				}
